...
const About = () => {
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 m-5">
<div className="max-w-7xl mx-auto sm:px-6 lg:px-8 backdrop-blur-3xl rounded-lg text-orange-800" style={{ backgroundImage: "linear-gradient(45deg, #ff9a9e 0%, #fad0c4 99%, #fad0c4 100%)" }}>
